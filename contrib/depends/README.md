...
A toolchain will be generated that's suitable for plugging into Bitquantum's
cmake. In the above example, a dir named x86_64-w64-mingw32 will be
created. To use it for Bitquantum, from the top of the Bitquantum source tree:
