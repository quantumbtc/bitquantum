...
RUN	git clone https://github.com/bitquantum-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/bitquantum-project/bitquantum
...
if [ ! -d sigs ]; then
	git clone https://github.com/bitquantum-project/gitian.sigs.git sigs
	cd sigs
