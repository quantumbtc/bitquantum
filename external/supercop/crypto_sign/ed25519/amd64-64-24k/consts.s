#ifdef __APPLE__
  #define BITQUANTUM_LOCAL_SYMBOL(x) .private_extern x
#else
  #define BITQUANTUM_LOCAL_SYMBOL(x) .hidden x
#endif
...
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
BITQUANTUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)
