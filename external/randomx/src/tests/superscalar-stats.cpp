...
int main() {
	...
	int isnCounts[(int)randomx::SuperbitquantumrInstructionType::COUNT] = { 0 };
	...
	for (int i = 0; i < count; ++i) {
		randomx::SuperbitquantumrProgram prog;
		randomx::Blake2Generator gen(seed, sizeof(seed), i);
		randomx::generateSuperbitquantumr(prog, gen);
	...
	for (unsigned j = 0; j < (int)randomx::SuperbitquantumrInstructionType::COUNT; ++j) {
